...
class BasicDroneController:
	...
	def callback(self,data):
		...
		Xleft = data.paddles[0].rotation.translation.x
		Yleft = data.paddles[0].rotation.translation.y
		Zleft = data.paddles[0].rotation.translation.z
		...
		Xright = data.paddles[1].rotation.translation.x
		Yright = data.paddles[1].rotation.translation.y
		Zright = data.paddles[1].rotation.translation.z
