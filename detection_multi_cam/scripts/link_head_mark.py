    ...
    def joint_state_callback(self,data):   
        if self.detection==1 :
            ...
            try:
                ...
                if self.flag==6:
                    self.broadcaster.sendTransform(self.pos,(0,0,0,1),now,"/mon_tf/head",markeur)#3
                    ...
                    _,self.foot_map_r= self.listener.lookupTransform("base_footprint","map", rospy.Time(0))
                    #self.broadcaster.sendTransform(self.pos,self.foot_map_r,now,"/mon_tf/head",markeur)#3
                    self.flag=2
                ...
                if self.flag==0:
                    ...
                    self.pos=((dist_x - self.foot_map_t[0]), -(dist_y - self.foot_map_t[1]), self.dist_mark_tete )
                    print  "self.foot_map_t", self.foot_map_t
                    print  "dist_x",dist_x, "dist_y",dist_y
                    print "aaaaaaaaaaaaaaaaaaaaaaaaaaaa", self.pos 
